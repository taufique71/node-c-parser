...
var conditional_expr = require("./conditional_expr").conditional_expr;
var unary_expr = require("./unary_expr").unary_expr;
var assignment_operator = require("./assignment_operator").assignment_operator;
...
var assignment_expr = function(token_stream, arrow){
    var new_node = {};
