 ...
 *                      |  declaration_specifiers declarator compount_stmt
 *                      |  declarator declaration_list compount_stmt
...
var function_definition = function(token_rules, arrow){
    var new_node = {};
    var new_arrow = _.clone(arrow);
    new_node["title"] = "function_definition";
    new_node["children"] = [];
    iterate_over_rules(token_streams, arrow, list_of_rules, new_node);
